...
public class Accion_Cosechar : GoapAction
{
    public Accion_Cosechar()
    {
        // Donde vamos a poner las precondiciones y efectos de la acción
        AddPrecondition("listoCosechar", true);

       
        AddEffect("hayComida", true);
    ...
    public override bool checkPreconditions(GameObject go)
    {
        ...
        GameObject[] forjas = GameObject.FindGameObjectsWithTag("Campo");
